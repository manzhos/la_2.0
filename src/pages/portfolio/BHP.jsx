...
const Images    = [],
      itemData  = [];
for (let i=1; i<=69; i++) {
  Images[i] = require(`../../public/assets/portfolio/barc_hotel_penthouse/bhp_${i}.jpg`)
}
Images.map((image, key)=>{
  itemData.push({ src: image, title: `bhp_${key}` })
})
...
const BHP = () => {  
  ...
  return(
    <Box className="container">
      ...
      <h2 style={{ textAlign:"center" }}>Barcelona Hotel Penthouse Renovation</h2>
