...
import mainStatic from '../public/assets/main_video.png'
// import mainVideo from 'https://lazzarottiassociati.com/wp-content/uploads/2022/10/Busov.mp4';
      ...
      {!isMobileMode &&
        <div className="container">
          ...
          <div className="main-video" style={{ backgroundColor: 'gray' }}>
            <img src={mainStatic} className="main-video" />
