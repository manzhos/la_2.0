...
const Images    = [],
      itemData  = [];
for (let i=1; i<=45; i++) {
  Images[i] = require(`../../public/assets/portfolio/villa_in_pineta/villa_in_pineta_${i}.jpg`)
}
Images.map((image, key)=>{
  itemData.push({ src: image, title: `villa_in_pineta_${key}` })
})
...
const VillaInPineta = () => {  
  ...
  return(
    <Box className="container">
      ...
      <h2 style={{ textAlign:"center" }}>Villa In Pineta</h2>
