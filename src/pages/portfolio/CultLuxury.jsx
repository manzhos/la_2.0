...
const Images    = [],
      itemData  = [];
for (let i=1; i<=25; i++) {
  Images[i] = require(`../../public/assets/portfolio/cult_luxury/cult_luxury_${i}.jpg`)
}
Images.map((image, key)=>{
  itemData.push({ src: image, title: `cult_luxury_${key}` })
})
...
const CultLuxury = () => {  
  ...
  return(
    <Box className="container">
      ...
      <h2 style={{ textAlign:"center" }}>CULT Luxury</h2>
