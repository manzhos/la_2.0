...
const Images    = [],
      itemData  = [];
for (let i=1; i<=3; i++) {
  Images[i] = require(`../../public/assets/portfolio/cult_tsum/cult_tsum_${i}.jpg`)
}
Images.map((image, key)=>{
  itemData.push({ src: image, title: `cult_tsum_${key}` })
})
...
const CultTsum = () => {  
  ...
  return(
    <Box className="container">
      ...
      <h2 style={{ textAlign:"center" }}>CULT TSUM Kiev</h2>
