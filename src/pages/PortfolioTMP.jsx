  ...
  return(
    <Box className="container">
      ...
      <div style={{ width:"100%", display:"flex", flexDirection:"row", justifyContent:"center" }}>
        <a href="#" style={{ textDecoration:"none" }}><h2 style={{ borderBottom:"1px solid black" }}>RESIDENTIAL</h2></a>
        <h2 style={{ margin:"0 20px" }}>|</h2>
        <a href="#" style={{ textDecoration:"none" }}><h2 style={{ borderBottom:"1px solid black" }}>COMMERCIAL</h2></a>
      </div>
      <div className="spacing-64">&nbsp;</div>
