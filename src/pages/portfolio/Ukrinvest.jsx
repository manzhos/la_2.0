...
const Images    = [],
      itemData  = [];
for (let i=1; i<=18; i++) {
  Images[i] = require(`../../public/assets/portfolio/ukrinvest/ukrinvest_${i}.jpg`)
}
Images.map((image, key)=>{
  itemData.push({ src: image, title: `ukrinvest_${key}` })
})
...
const Ukrinvest = () => {  
  ...
  return(
    <Box className="container">
      ...
      <h2 style={{ textAlign:"center" }}>Ukrinvest</h2>
