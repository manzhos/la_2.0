...
const Images    = [],
      itemData  = [];
for (let i=1; i<=58; i++) {
  Images[i] = require(`../../public/assets/portfolio/classic_winter_chalet/cwc_${i}.jpg`)
}
Images.map((image, key)=>{
  itemData.push({ src: image, title: `cwc_${key}` })
})
...
const CWC = () => {  
  ...
  return(
    <Box className="container">
      ...
      <h2 style={{ textAlign:"center" }}>CLASSIC WINTER CHALET </h2>
