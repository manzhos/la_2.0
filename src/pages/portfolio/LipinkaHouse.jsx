...
const Images    = [],
      itemData  = [];
for (let i=1; i<=20; i++) {
  Images[i] = require(`../../public/assets/portfolio/lipinka_house/lipinka_${i}.jpg`)
}
Images.map((image, key)=>{
  itemData.push({ src: image, title: `lipinka_${key}` })
})
...
const LipinkaHouse = () => {  
  ...
  return(
    <Box className="container">
      ...
      <h2 style={{ textAlign:"center" }}>Lipinka House</h2>
