...
const Images    = [],
      itemData  = [];
for (let i=1; i<=85; i++) {
  Images[i] = require(`../../public/assets/portfolio/amb_vie/amb_vie_${i}.jpg`)
}
Images.map((image, key)=>{
  itemData.push({ src: image, title: `AMB_WIEN_${key}` })
})
...
const AMB_VIE = () => {  
  ...
  return(
    <Box className="container">
      ...
      <h2 style={{ textAlign:"center" }}>THE AMBASSY WIEN GLAMOUR PENTHOUSE</h2>
