...
const Images    = [],
      itemData  = [];
for (let i=1; i<=23; i++) {
  Images[i] = require(`../../public/assets/portfolio/edeld_apt_2a/ed_apt2a_${i}.jpg`)
}
Images.map((image, key)=>{
  itemData.push({ src: image, title: `ed2a_${key}` })
})
...
const Edeldorf_2a = () => {  
  ...
  return(
    <Box className="container">
      ...
      <h2 style={{ textAlign:"center" }}>Edeldorf 2A</h2>
