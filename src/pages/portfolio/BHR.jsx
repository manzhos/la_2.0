...
const Images    = [],
      itemData  = [];
for (let i=1; i<=13; i++) {
  Images[i] = require(`../../public/assets/portfolio/barc_hotel_room/bhr_${i}.jpg`)
}
Images.map((image, key)=>{
  itemData.push({ src: image, title: `bhr_${key}` })
})
...
const BHR = () => {  
  ...
  return(
    <Box className="container">
      ...
      <h2 style={{ textAlign:"center" }}>Barcelona Hotel Typical room</h2>
