...
const Images    = [],
      itemData  = [];
for (let i=1; i<=31; i++) {
  Images[i] = require(`../../public/assets/portfolio/barc_avendid_diagonal/bad_${i}.jpg`)
}
Images.map((image, key)=>{
  itemData.push({ src: image, title: `bad_${key}` })
})
...
const BAD = () => {  
  ...
  return(
    <Box className="container">
      ...
      <h2 style={{ textAlign:"center" }}>Barcelona Avenid Diagonal</h2>
