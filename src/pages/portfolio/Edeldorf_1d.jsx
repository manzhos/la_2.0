...
const Images    = [],
      itemData  = [];
for (let i=1; i<=22; i++) {
  Images[i] = require(`../../public/assets/portfolio/edeld_apt_1d/ed_apt1d_${i}.jpg`)
}
Images.map((image, key)=>{
  itemData.push({ src: image, title: `ed1d_${key}` })
})
...
const Edeldorf_1d = () => {  
  ...
  return(
    <Box className="container">
      ...
      <h2 style={{ textAlign:"center" }}>Edeldorf 1D</h2>
