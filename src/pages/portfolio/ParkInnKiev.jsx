...
const Images    = [],
      itemData  = [];
for (let i=1; i<=11; i++) {
  Images[i] = require(`../../public/assets/portfolio/parkinn_kiev/park_inn_${i}.jpg`)
}
Images.map((image, key)=>{
  itemData.push({ src: image, title: `park_inn_${key}` })
})
...
const ParkInnKiev = () => {  
  ...
  return(
    <Box className="container">
      ...
      <h2 style={{ textAlign:"center" }}>Park Inn Kiev</h2>
