...
const Images    = [],
      itemData  = [];
for (let i=1; i<=56; i++) {
  Images[i] = require(`../../public/assets/portfolio/parkinn_donetsk/parkinn_donetsk_${i}.jpg`)
}
Images.map((image, key)=>{
  itemData.push({ src: image, title: `parkinn_donetsk_${key}` })
})

const ParkInnDonetsk = () => {  
  ...
  return(
    <Box className="container">
      ...
      <h2 style={{ textAlign:"center" }}>Park Inn Donetsk</h2>
